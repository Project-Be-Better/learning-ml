...
class ExperimentTracker:
    ...
    Writes runs as JSON manifests to mlruns/ directory.
    """
...
# =============================================================================
# SECTION 2: TELEMATICS EVENT PARSING & AGGREGATION
# =============================================================================
...
def train_smoothness_model(
    ...
    with tracker.start_run(experiment="tracedata-smoothness-scoring") as run:
        tracker.log_params(params)
        tracker.log_param("train_size", len(X_train))
        tracker.log_param("test_size", len(X_test))
        tracker.log_param("num_features", len(available_features))
        tracker.log_param("features_used", ",".join(available_features))
